...
trait Questions
{
    public static $questions = [
        ...
        4 => array(
            ...
            'type' => 1,
            'answers' => array('coś lekkiego', 'coś pośrodku', 'coś złożonego'),
        ...
        5 => array(
            ...
            'type' => 1,
            'answers' => array('ledwie wyczuwalną', 'lekką', 'zdecydowanie wyczuwalną', 'mocną', 'jestem hopheadem')
        ),
        6 => array(
            'question' => 'Smakują Ci bardziej piwa jasne, czy piwa ciemne?',
            'type' => 1,
            'answers' => array('jasne', 'bez znaczenia', 'ciemne')
        ),
        7 => array(
            'question' => 'Smakują Ci bardziej piwa słodsze, czy piwa wytrawniejsze?',
            'type' => 1,
            'answers' => array('słodsze', 'bez znaczenia', 'wytrawniejsze')
        ),

        8 => array(
            'question' => 'Jak mocne i gęste piwa preferujesz?',
            'type' => 1,
            'answers' => array('wodniste i lekkie', 'średnie', 'mocne i gęste')
        ),
        9 => array(
        ...
        13 => array(
            ...
            'type' => 1,
            'answers' => array('chętnie', 'nie ma mowy'),
    ...
    public static $jsonReadyQuestions = [
        ...
        ['question' => 'Czy odpowiadałoby Ci piwo nieco przyprawowe?'],
        ['question' => 'Czy chciałbyś piwo w klimatach owocowych?'],
        ['question' => 'Co powiesz na piwo kwaśne?', 'answer' => ['chętnie', 'nie ma mowy']],
        ['question' => 'Czy odpowiadałby Ci smak wędzony/dymny w piwie?'],
        ['question' => 'Czy lubisz bourbon, whisky lub inne alkohole szlachetne?'],
    ];
