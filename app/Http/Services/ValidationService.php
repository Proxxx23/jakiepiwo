...
class ValidationService
{
    ...
    {
        $email = \filter_var(\trim($_POST['email']), FILTER_SANITIZE_EMAIL);
    ...
    {
        return !\in_array($answer, Questions::$questions[6]['answers'], true) ||
            !\in_array($answer, Questions::$questions[8]['answers'], true);
    }
}
